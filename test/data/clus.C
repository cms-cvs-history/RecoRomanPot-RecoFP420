...
//      TFile *hfile = new TFile("newntfp420.root", "READ");     //open file
      ...
      printf("clus: root file TheAnalysis is Open    \n");
    hfile.ls();
    hfile->Print();
//    getchar();
//
//    TPostScript* psfile = new TPostScript("zhplot.ps",111);
    TPostScript psfile ("clus.ps", 111);
//
...
//       mpelec4->GetYaxis()->SetLabelSize(0.04);
     ...
     c1->cd(3);
     TF1 *f1 = new TF1("f1","gaus",-0.04,0.04); Xstrip_deltaxx_clsize3->Fit("f1","RI");
